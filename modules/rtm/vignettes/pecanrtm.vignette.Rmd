...
par(mfrow=c(1,1))
samples.mat <- as.matrix(inversion.output$samples)[-seq(2000,1), 1:3]  # Reduce size  
pairs(samples.mat, pch=".")  

means <- head(unlist(inversion.output$results[grep("mu", names(inversion.output$results))]), 3)  # Reduce stored data  
