...
if (file.exists("inversion.output.rds")) {
    ...
    # Step 1: Run invert.auto() and log execution time
    start_time <- Sys.time()
    print(paste("Starting invert.auto() at:", start_time))
    ...
    mid_time <- Sys.time()
    print(paste("invert.auto() completed at:", mid_time))
    print(paste("Time taken for invert.auto():", difftime(mid_time, start_time, units = "secs")))

    # Step 2: Save the results and log execution time
    print(paste("Starting saveRDS() at:", mid_time))
    
    saveRDS(inversion.output, "inversion.output.rds")

    end_time <- Sys.time()
    print(paste("saveRDS() completed at:", end_time))
    print(paste("Time taken for saveRDS():", difftime(end_time, mid_time, units = "secs")))

    print(paste("Total execution time:", difftime(end_time, start_time, units = "secs")))
}
