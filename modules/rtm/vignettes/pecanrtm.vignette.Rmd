...
invert.options$ngibbs.max <- 1000 # Reduce from 5e4 to 1000
invert.options$ngibbs.min <- 500  # Reduce from 5000 to 500
invert.options$burnin <- 200      # Reduce from 1000 to 200
invert.options$iter_conv_check <- 500 # Reduce from 15000 to 500
