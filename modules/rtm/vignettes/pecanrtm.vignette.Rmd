...
log_message <- function(msg) {
  timestamp <- Sys.time()
  message <- paste("[LOG]", timestamp, msg)
  print(message)
  flush.console()  # Ensures immediate log output in GitHub Actions
}

# Start timing invert.auto()
start_time <- Sys.time()
log_message("Starting invert.auto()")
...
mid_time <- Sys.time()
log_message(paste("invert.auto() completed. Time taken:", difftime(mid_time, start_time, units = "secs")))

# Start timing saveRDS()
log_message("Starting saveRDS()")

saveRDS(inversion.output, "inversion.output.rds")

end_time <- Sys.time()
log_message(paste("saveRDS() completed. Time taken:", difftime(end_time, mid_time, units = "secs")))

# Total execution time
log_message(paste("Total script execution time:", difftime(end_time, start_time, units = "secs")))
