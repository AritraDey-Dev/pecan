...
```{r}
if (file.exists("inversion.output.qs")) {
    inversion.output <- qread("inversion.output.qs")
} else {
    inversion.output <- invert.auto(observed = observed,
                                    invert.options = invert.options,
                                    quiet = TRUE,
                                    parallel = FALSE)
    qsave(inversion.output, "inversion.output.qs", preset = "high")
}
