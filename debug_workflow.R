...
# ----------------------------------------------------------------------
library("PEcAn.all")
source("/pecan/modules/meta.analysis/R/approx.posterior.R")
source("/pecan/modules/uncertainty/R/debug_ensemble.R")

# Override package functions with debug versions
assignInNamespace("input.ens.gen", input.ens.gen, ns = "PEcAn.uncertainty")
assignInNamespace("get.ensemble.samples", get.ensemble.samples, ns = "PEcAn.uncertainty")
